...
fibonacci = {
    ...
    "user_func": "fib",
    "test_args": [[0], [1], [7]],
    "expected": {'COMPILERLOG': {'ERROR': (), 'WARNINGS': []}, 'EXECUTELOG': {'ERROR': ()},
...
multiplication_wrong = {
    ...
    "user_func": "mult",
    "test_args": [[2, 2, 2]],
    "not_expected": {'COMPILERLOG': {'ERROR': (), 'WARNINGS': []}, 'EXECUTELOG': {'ERROR': ()},
                 'RESULTLOG': {'0': ([2, 2, 2], [8])}}
}
...
infinite_loop = {
    ...
    "expected": {'COMPILERLOG': {'ERROR': (), 'WARNINGS': []},
                 'EXECUTELOG': {'ERROR': ('TimeoutError: Code execution has been interrupted. Maximum execution time '
                                         'has been reached!',)},
                 'RESULTLOG': {}}
}
